      ...
      if (end === true) {
        ...
        $.get("/api/game/", data, function(data){
          ...
          $('.modal.end').html(data.html).fadeIn(function(){
            ...
            $('.btn.next-lvl').off('click').on('click', function(){
              StartLevel(level + 1);
              $('.modal.end').hide();
            });
  ...
  $('.btn-handler').off('click').on('click', function(e){
    e.bubbles = false;
  ...
  $('#compost').off('click').on('click', function() {
  ...
  $('#special').off('click').on('click', function() {
    ...
    $('.modal.special').fadeIn(function() {
      $(this).find('.btn.close-special').off('click').on('click', function(e){
        SpecialReset();
        setTimeout(function() {
      ...
      // Option Select
      $('.option-select input[data-action="select"]').off('click').on('click', function(e){
      ...
      // Option Info
      $('.option-select input[data-action="info"]').off('click').on('click', function(e){
  ...
  $('.item:not(.open)').on('click', function(e){
    ...
    $(item).find('.item-bio').show(function(){
      ...
      // $('.glide__arrow').off('click').on('click', function(e){
      //   e.stopImmediatePropagation();
      //   e.stopPropagation();
      //   e.bubbles = false;
      ...
      $('.material').off('click').on('click', function(e){
